...
Author: Mike Corrigan <a href="&#x6d;&#97;&#x69;&#108;&#x74;&#111;&#58;&#x63;&#111;&#114;&#114;&#105;&#103;&#x61;&#110;&#64;&#x67;&#109;&#97;&#105;&#x6c;&#46;&#x63;&#111;&#109;">&#x63;&#111;&#114;&#114;&#105;&#103;&#x61;&#110;&#64;&#x67;&#109;&#97;&#105;&#x6c;&#46;&#x63;&#111;&#109;</a></p>
<p>This class implements tremolo notation.</p>
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Tremolo</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">Modifier</span> </span>{
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'tremolo'</span>; }
  <span class="hljs-keyword">constructor</span>(num) {
    ...
    <span class="hljs-keyword">this</span>.position = Modifier.Position.CENTER;
    <span class="hljs-keyword">this</span>.code = <span class="hljs-string">"v74"</span>;
    <span class="hljs-keyword">this</span>.shift_right = <span class="hljs-number">-2</span>;
    <span class="hljs-keyword">this</span>.y_spacing = <span class="hljs-number">4</span>;

    <span class="hljs-keyword">this</span>.render_options = {
      font_scale: <span class="hljs-number">35</span>,
  ...
  getCategory() { <span class="hljs-keyword">return</span> Tremolo.CATEGORY; }
  ...
  draw() {
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.context) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"NoContext"</span>,
      <span class="hljs-string">"Can't draw Tremolo without a context."</span>);
    <span class="hljs-keyword">if</span> (!(<span class="hljs-keyword">this</span>.note &amp;&amp; (<span class="hljs-keyword">this</span>.index != <span class="hljs-literal">null</span>))) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"NoAttachedNote"</span>,
      <span class="hljs-string">"Can't draw Tremolo without a note and index."</span>);
    ...
    <span class="hljs-keyword">var</span> x = start.x;
    <span class="hljs-keyword">var</span> y = start.y;

    x += <span class="hljs-keyword">this</span>.shift_right;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.num; ++i) {
      Glyph.renderGlyph(<span class="hljs-keyword">this</span>.context, x, y,
                           <span class="hljs-keyword">this</span>.render_options.font_scale, <span class="hljs-keyword">this</span>.code);
      y += <span class="hljs-keyword">this</span>.y_spacing;
    }
  }
}</pre></div>
