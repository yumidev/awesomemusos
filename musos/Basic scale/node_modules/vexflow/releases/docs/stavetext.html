...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">StaveText</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StaveModifier</span> </span>{
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'stavetext'</span>; }

  <span class="hljs-keyword">constructor</span>(text, position, options) {
    <span class="hljs-keyword">super</span>();

    <span class="hljs-keyword">this</span>.setWidth(<span class="hljs-number">16</span>);
    ...
    <span class="hljs-keyword">this</span>.options = {
      ...
      shift_y: <span class="hljs-number">0</span>,
  ...
  getCategory() { <span class="hljs-keyword">return</span> StaveText.CATEGORY; }
  setStaveText(text) { <span class="hljs-keyword">this</span>.text = text; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }
  ...
  draw(stave) {
    <span class="hljs-keyword">if</span> (!stave.context) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"NoContext"</span>,
      <span class="hljs-string">"Can't draw stave text without a context."</span>);
    ...
    <span class="hljs-keyword">var</span> text_width = ctx.measureText(<span class="hljs-string">""</span> + <span class="hljs-keyword">this</span>.text).width;

    <span class="hljs-keyword">var</span> x, y;
    <span class="hljs-keyword">var</span> Position = StaveModifier.Position;
    <span class="hljs-keyword">switch</span>(<span class="hljs-keyword">this</span>.position) {
      ...
      <span class="hljs-keyword">case</span> Position.RIGHT:
        y = (stave.getYForLine(<span class="hljs-number">0</span>) + stave.getBottomLineY()) / <span class="hljs-number">2</span> + <span class="hljs-keyword">this</span>.options.shift_y;
        <span class="hljs-keyword">if</span>(<span class="hljs-keyword">this</span>.position == Position.LEFT) {
          x = stave.getX() - text_width - <span class="hljs-number">24</span> + <span class="hljs-keyword">this</span>.options.shift_x;
        }
        <span class="hljs-keyword">else</span> {
          x = stave.getX() + stave.getWidth() + <span class="hljs-number">24</span> + <span class="hljs-keyword">this</span>.options.shift_x;
        }
        <span class="hljs-keyword">break</span>;
      <span class="hljs-keyword">case</span> Position.ABOVE:
      <span class="hljs-keyword">case</span> Position.BELOW:
        <span class="hljs-keyword">var</span> Justification = TextNote.Justification;
        x = stave.getX() + <span class="hljs-keyword">this</span>.options.shift_x;
        <span class="hljs-keyword">if</span>(<span class="hljs-keyword">this</span>.options.justification == Justification.CENTER) {
          x += stave.getWidth() / <span class="hljs-number">2</span> - text_width / <span class="hljs-number">2</span>;
        }
        <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(<span class="hljs-keyword">this</span>.options.justification == Justification.RIGHT) {
          x += stave.getWidth() - text_width;
        }

        <span class="hljs-keyword">if</span>(<span class="hljs-keyword">this</span>.position == Position.ABOVE) {
          y = stave.getYForTopText(<span class="hljs-number">2</span>) + <span class="hljs-keyword">this</span>.options.shift_y;
        }
        <span class="hljs-keyword">else</span> {
          y = stave.getYForBottomText(<span class="hljs-number">2</span>) + <span class="hljs-keyword">this</span>.options.shift_y;
        }
        <span class="hljs-keyword">break</span>;
      <span class="hljs-keyword">default</span>:
        <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"InvalidPosition"</span>,
          <span class="hljs-string">"Value Must be in Modifier.Position."</span>);
    }

    ctx.fillText(<span class="hljs-string">""</span> + <span class="hljs-keyword">this</span>.text, x, y + <span class="hljs-number">4</span>);
    ctx.restore();
