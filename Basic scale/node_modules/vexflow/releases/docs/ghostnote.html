...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">GhostNote</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StemmableNote</span> </span>{
  <span class="hljs-comment">/** @constructor */</span>
  <span class="hljs-keyword">constructor</span>(parameter) {</pre></div>
        ...
        <p>Sanity check</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">if</span> (!parameter) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RuntimeError(<span class="hljs-string">"BadArguments"</span>,
          <span class="hljs-string">"Ghost note must have valid initialization data to identify "</span> +
          <span class="hljs-string">"duration."</span>);
    }

    <span class="hljs-keyword">var</span> note_struct;</pre></div>
        ...
        <p>Preserve backwards-compatibility</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span>(parameter) === <span class="hljs-string">"string"</span>) {
      note_struct = { duration: parameter };
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span>(parameter) === <span class="hljs-string">"object"</span>) {
    ...
    <span class="hljs-keyword">super</span>(note_struct);</pre></div>
        ...
        <p>Note properties</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.setWidth(<span class="hljs-number">0</span>);
  }

  isRest() { <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>; }

  setStave(stave) { GhostNote.superclass.setStave.call(<span class="hljs-keyword">this</span>, stave); }

  addToModifierContext() { <span class="hljs-comment">/* intentionally overridden */</span> <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }
  ...
  draw() {
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.stave) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"NoStave"</span>, <span class="hljs-string">"Can't draw without a stave."</span>);</pre></div>
        ...
        <p>Draw the modifiers</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.modifiers.length; ++i) {
      <span class="hljs-keyword">var</span> modifier = <span class="hljs-keyword">this</span>.modifiers[i];
