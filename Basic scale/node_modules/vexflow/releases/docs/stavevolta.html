...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Volta</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StaveModifier</span> </span>{
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'voltas'</span>; }
  <span class="hljs-keyword">static</span> get type() {
    <span class="hljs-keyword">return</span> {
      NONE: <span class="hljs-number">1</span>,
      BEGIN: <span class="hljs-number">2</span>,
      MID: <span class="hljs-number">3</span>,
      END: <span class="hljs-number">4</span>,
      BEGIN_END: <span class="hljs-number">5</span>
    };
  }

  <span class="hljs-keyword">constructor</span>(type, number, x, y_shift) {
    <span class="hljs-keyword">super</span>();
    <span class="hljs-keyword">this</span>.volta = type;
  ...
  getCategory() { <span class="hljs-keyword">return</span> Volta.CATEGORY; }
  ...
  draw(stave, x) {
    ...
    <span class="hljs-keyword">var</span> width = stave.width;
    <span class="hljs-keyword">var</span> top_y = stave.getYForTopText(stave.options.num_lines) + <span class="hljs-keyword">this</span>.y_shift;
    <span class="hljs-keyword">var</span> vert_height = <span class="hljs-number">1.5</span> * stave.options.spacing_between_lines_px;
    <span class="hljs-keyword">switch</span>(<span class="hljs-keyword">this</span>.volta) {
      <span class="hljs-keyword">case</span> Volta.type.BEGIN:
        ctx.fillRect(<span class="hljs-keyword">this</span>.x + x, top_y, <span class="hljs-number">1</span>, vert_height);
        <span class="hljs-keyword">break</span>;
      <span class="hljs-keyword">case</span> Volta.type.END:
        width -= <span class="hljs-number">5</span>;
        ctx.fillRect(<span class="hljs-keyword">this</span>.x + x + width, top_y, <span class="hljs-number">1</span>, vert_height);
        <span class="hljs-keyword">break</span>;
      <span class="hljs-keyword">case</span> Volta.type.BEGIN_END:
        ...
        <p>If the beginning of a volta, draw measure number</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.volta == Volta.type.BEGIN ||
        <span class="hljs-keyword">this</span>.volta == Volta.type.BEGIN_END) {
      ctx.save();
      ...
      ctx.fillText(<span class="hljs-keyword">this</span>.number, <span class="hljs-keyword">this</span>.x + x + <span class="hljs-number">5</span>, top_y + <span class="hljs-number">15</span>);
      ctx.restore();
    }
    ctx.fillRect(<span class="hljs-keyword">this</span>.x + x, top_y, width, <span class="hljs-number">1</span>);
