...
as an integer tick value.</p>
  ...
  <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>; i &lt; voices.length; ++i) {
    ...
    <span class="hljs-keyword">var</span> lcm = Fraction.LCM(resolutionMultiplier,
...
of fractional tick values is needed.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> ticksUsed = <span class="hljs-keyword">new</span> Fraction(<span class="hljs-number">0</span>, resolutionMultiplier);
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> params == <span class="hljs-string">"object"</span>) {
      ...
      opts.auto_beam = params;
        ...
        <p>Start by creating a voice and adding all the notes to it.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> voice = <span class="hljs-keyword">new</span> Voice(Flow.TIME4_4).
...
<li><code>align_rests</code> aligns rests with nearby notes.</li>
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> params == <span class="hljs-string">"object"</span>) {
      ...
      opts.auto_beam = params;
        ...
        <p>Create a <code>4/4</code> voice for <code>notes</code>.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> notevoice = <span class="hljs-keyword">new</span> Voice(Flow.TIME4_4).
      setMode(Voice.Mode.SOFT);
    notevoice.addTickables(notes);</pre></div>
        ...
        <p>Create a <code>4/4</code> voice for <code>tabnotes</code>.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> tabvoice = <span class="hljs-keyword">new</span> Voice(Flow.TIME4_4).
      setMode(Voice.Mode.SOFT);
...
<li><code>align_tuplets</code>: If set to false, ignores tuplets.</li>
          ...
          <div class='highlight'><pre>  <span class="hljs-keyword">static</span> AlignRestsToNotes(notes, align_all_notes, align_tuplets) {
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; notes.length; ++i) {
      <span class="hljs-keyword">if</span> (notes[i] <span class="hljs-keyword">instanceof</span> StaveNote &amp;&amp; notes[i].isRest()) {
...
align non-beamed notes.</p>
          ...
          <div class='highlight'><pre>  alignRests(voices, align_all_notes) {
    <span class="hljs-keyword">if</span> (!voices || !voices.length) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"BadArgument"</span>,
...
of all the tickables/notes in the formatter.</p>
          ...
          <div class='highlight'><pre>  preFormat(justifyWidth, rendering_context, voices, stave) {</pre></div>
...
in the voices.</p>
          ...
          <div class='highlight'><pre>  postFormat() {</pre></div>
