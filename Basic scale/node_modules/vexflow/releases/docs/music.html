...
has an <code>F#</code> state.</p>
    ...
    <span class="hljs-keyword">var</span> scaleName = Music.scaleTypes[keySigParts.type];
    ...
    <span class="hljs-keyword">var</span> noteLocation = Music.root_indices[keySigParts.root];
