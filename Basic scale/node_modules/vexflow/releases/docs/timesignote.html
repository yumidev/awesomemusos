...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">TimeSigNote</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">Note</span> </span>{
  <span class="hljs-keyword">constructor</span>(timeSpec, customPadding) {
    <span class="hljs-keyword">super</span>({ duration: <span class="hljs-string">'b'</span> });

    <span class="hljs-keyword">var</span> timeSignature = <span class="hljs-keyword">new</span> TimeSignature(timeSpec, customPadding);
    <span class="hljs-keyword">this</span>.timeSig = timeSignature.getTimeSig();
    <span class="hljs-keyword">this</span>.setWidth(<span class="hljs-keyword">this</span>.timeSig.glyph.getMetrics().width);</pre></div>
  ...
  draw() {
    ...
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.timeSig.glyph.getContext()) {
      <span class="hljs-keyword">this</span>.timeSig.glyph.setContext(<span class="hljs-keyword">this</span>.context);
    }

    <span class="hljs-keyword">this</span>.timeSig.glyph.setStave(<span class="hljs-keyword">this</span>.stave);
    <span class="hljs-keyword">this</span>.timeSig.glyph.setYShift(
      <span class="hljs-keyword">this</span>.stave.getYForLine(<span class="hljs-keyword">this</span>.timeSig.line) - <span class="hljs-keyword">this</span>.stave.getYForGlyphs());
    <span class="hljs-keyword">this</span>.timeSig.glyph.renderToStave(<span class="hljs-keyword">this</span>.getAbsoluteX());
  }
}</pre></div>
