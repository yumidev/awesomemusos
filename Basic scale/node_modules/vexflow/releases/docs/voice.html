...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Voice</span> </span>{</pre></div>
...
FULL:   Ticks do not need to fill the voice, but can’t exceed the maximum
    ...
    <span class="hljs-keyword">return</span> {
      STRICT: <span class="hljs-number">1</span>,
      SOFT:   <span class="hljs-number">2</span>,
      FULL:   <span class="hljs-number">3</span>
    };
  }

  <span class="hljs-keyword">constructor</span>(time) {
    <span class="hljs-keyword">this</span>.time = Vex.Merge({
    ...
    <span class="hljs-keyword">this</span>.boundingBox = <span class="hljs-literal">null</span>;</pre></div>
  ...
  setMode(mode) { <span class="hljs-keyword">this</span>.mode = mode; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }</pre></div>
    ...
    <span class="hljs-keyword">var</span> stave, boundingBox, bb, i;

    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.boundingBox) {
      <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.stave) <span class="hljs-keyword">throw</span> Vex.RERR(<span class="hljs-string">"NoStave"</span>, <span class="hljs-string">"Can't get bounding box without stave."</span>);
...
and preformatters to associate them with the right modifierContexts.</p>
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.mode == Voice.Mode.STRICT ||
        <span class="hljs-keyword">this</span>.mode == Voice.Mode.FULL) {
    ...
    <span class="hljs-keyword">if</span> (!tickable.shouldIgnoreTicks()) {
      <span class="hljs-keyword">var</span> ticks = tickable.getTicks();</pre></div>
      ...
      <span class="hljs-keyword">if</span> ((<span class="hljs-keyword">this</span>.mode == Voice.Mode.STRICT ||
        ...
        <span class="hljs-keyword">this</span>.totalTicks.subtract(ticks);
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; tickables.length; ++i) {
    ...
    <span class="hljs-keyword">this</span>.tickables.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">tickable</span>) </span>{
...
already set.</p>
          ...
          <div class='highlight'><pre>  draw(context, stave) {
    <span class="hljs-keyword">var</span> boundingBox = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.tickables.length; ++i) {
      <span class="hljs-keyword">var</span> tickable = <span class="hljs-keyword">this</span>.tickables[i];</pre></div>
      ...
      <span class="hljs-keyword">if</span> (!tickable.getStave()) {
        <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RuntimeError(<span class="hljs-string">"MissingStave"</span>,
          <span class="hljs-string">"The voice cannot draw tickables without staves."</span>);
      }
      ...
      <span class="hljs-keyword">if</span> (i &gt; <span class="hljs-number">0</span> &amp;&amp; boundingBox) {
        <span class="hljs-keyword">var</span> tickable_bb = tickable.getBoundingBox();
