...
<span class="hljs-keyword">import</span> { Renderer } <span class="hljs-keyword">from</span> <span class="hljs-string">'./renderer'</span>;</pre></div>
        ...
        <p>To enable logging for this class. Set <code>Vex.Flow.TextBracket.DEBUG</code> to <code>true</code>.</p>
          ...
          <div class='highlight'><pre><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">L</span>(<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">if</span> (TextBracket.DEBUG) Vex.L(<span class="hljs-string">"Vex.Flow.TextBracket"</span>, <span class="hljs-built_in">arguments</span>); }

<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">TextBracket</span> </span>{
  <span class="hljs-keyword">static</span> get Positions() {
  ...
  <span class="hljs-keyword">constructor</span>(bracket_data) {
    <span class="hljs-keyword">this</span>.start = bracket_data.start;
    <span class="hljs-keyword">this</span>.stop = bracket_data.stop;

    <span class="hljs-keyword">this</span>.text = bracket_data.text || <span class="hljs-string">""</span>;
    <span class="hljs-keyword">this</span>.superscript = bracket_data.superscript || <span class="hljs-string">""</span>;

    <span class="hljs-keyword">this</span>.position = bracket_data.position || TextBracket.Positions.TOP;
    ...
    <span class="hljs-keyword">this</span>.font = {
      ...
      weight: <span class="hljs-string">"italic"</span>
    };

    <span class="hljs-keyword">this</span>.render_options = {
      dashed: <span class="hljs-literal">true</span>,
      dash: [<span class="hljs-number">5</span>],
      color: <span class="hljs-string">"black"</span>,
      line_width: <span class="hljs-number">1</span>,
      show_bracket: <span class="hljs-literal">true</span>,
      bracket_height: <span class="hljs-number">8</span>,</pre></div>
...
optionally set the <code>dash</code> pattern by passing in an array of numbers</p>
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
        ...
        <p>Set the staff line to render the bracket on</p>
    ...
    <span class="hljs-keyword">switch</span>(<span class="hljs-keyword">this</span>.position) {
      ...
      <span class="hljs-keyword">case</span> TextBracket.Positions.BOTTOM:
        y =  <span class="hljs-keyword">this</span>.start.getStave().getYForBottomText(<span class="hljs-keyword">this</span>.line);
        <span class="hljs-keyword">break</span>;
    }</pre></div>
        ...
        <p>Get the preliminary start and stop coordintates for the bracket</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> start = { x: <span class="hljs-keyword">this</span>.start.getAbsoluteX(), y: y};
    <span class="hljs-keyword">var</span> stop = { x: <span class="hljs-keyword">this</span>.stop.getAbsoluteX(), y: y };
    ...
    <span class="hljs-keyword">var</span> bracket_height = <span class="hljs-keyword">this</span>.render_options.bracket_height * <span class="hljs-keyword">this</span>.position;
    ...
    <span class="hljs-keyword">this</span>.applyStyle(ctx);</pre></div>
        ...
        <p>Get the width and height for the octave number</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> main_width = ctx.measureText(<span class="hljs-keyword">this</span>.text).width;
    <span class="hljs-keyword">var</span> main_height = ctx.measureText(<span class="hljs-string">"M"</span>).width;</pre></div>
        ...
        <p>Calculate the y position for the super script</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> super_y = start.y - (main_height/<span class="hljs-number">2.5</span>);</pre></div>
    ...
    ctx.fillText(<span class="hljs-keyword">this</span>.superscript, start.x + main_width + <span class="hljs-number">1</span>, super_y);</pre></div>
        ...
        <p>Determine width and height of the superscript</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> superscript_width = ctx.measureText(<span class="hljs-keyword">this</span>.superscript).width;
    <span class="hljs-keyword">var</span> super_height = ctx.measureText(<span class="hljs-string">"M"</span>).width;</pre></div>
        ...
        <p>Setup initial coordinates for the bracket line</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> start_x = start.x;
    <span class="hljs-keyword">var</span> line_y = super_y;
    <span class="hljs-keyword">var</span> end_x = stop.x + <span class="hljs-keyword">this</span>.stop.getGlyph().head_width;</pre></div>
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.render_options.dashed) {</pre></div>
        ...
        <p>Main line</p>
          ...
          <div class='highlight'><pre>      Renderer.drawDashedLine(ctx, start_x, line_y, end_x, line_y,
        <span class="hljs-keyword">this</span>.render_options.dash);</pre></div>
        ...
        Renderer.drawDashedLine(ctx, end_x, line_y + (<span class="hljs-number">1</span> * <span class="hljs-keyword">this</span>.position),
          end_x, line_y + bracket_height, <span class="hljs-keyword">this</span>.render_options.dash);
      }
