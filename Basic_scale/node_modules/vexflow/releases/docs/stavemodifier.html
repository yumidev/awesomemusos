...
<p>A base class for stave modifiers (e.g. clefs, key signatures)</p>

        
          <div class='highlight'><pre>
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">StaveModifier</span> </span>{
  <span class="hljs-keyword">static</span> get Position() {
    <span class="hljs-keyword">return</span> {
      ...
      BEGIN: <span class="hljs-number">5</span>,
      END: <span class="hljs-number">6</span>
    };
  }

  <span class="hljs-keyword">constructor</span>() {
    <span class="hljs-keyword">this</span>.padding = <span class="hljs-number">10</span>;
    <span class="hljs-keyword">this</span>.position = StaveModifier.Position.ABOVE;
  }

  getPosition() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.position; }
  setPosition(position) { <span class="hljs-keyword">this</span>.position = position; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }
  ...
  setWidth(width) { <span class="hljs-keyword">this</span>.width = width; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }
  ...
  getCategory() {<span class="hljs-keyword">return</span> <span class="hljs-string">""</span>;}
  makeSpacer(padding) {
    <span class="hljs-keyword">return</span> {
      getContext() { <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>; },
      setStave() {},
      renderToStave() {},
      getMetrics() {
        <span class="hljs-keyword">return</span> { width: padding };
      }
    };
  }
  ...
  getPadding(index) {
    <span class="hljs-keyword">return</span> (index !== <span class="hljs-literal">undefined</span> &amp;&amp; index &lt; <span class="hljs-number">2</span> ? <span class="hljs-number">0</span> : <span class="hljs-keyword">this</span>.padding);
  }
