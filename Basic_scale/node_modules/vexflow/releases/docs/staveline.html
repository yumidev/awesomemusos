...
purposes, such as diagrams.</p>
          ...
          <div class='highlight'><pre><span class="hljs-keyword">import</span> { Vex } <span class="hljs-keyword">from</span> <span class="hljs-string">'./vex'</span>;</pre></div>
...
<p>Draw an arrow head that connects between 3 coordinates</p>
  ...
  <span class="hljs-keyword">var</span> both_arrows = config.draw_start_arrow &amp;&amp; config.draw_end_arrow;

  <span class="hljs-keyword">var</span> x1 = point1.x;
  <span class="hljs-keyword">var</span> y1 = point1.y;
  <span class="hljs-keyword">var</span> x2 = point2.x;
  <span class="hljs-keyword">var</span> y2 = point2.y;</pre></div>
...
so that wide lines won’t put a flat end on the arrow.</p>
          ...
          <div class='highlight'><pre>  <span class="hljs-keyword">var</span> distance = <span class="hljs-built_in">Math</span>.sqrt((x2-x1)*(x2-x1)+(y2-y1)*(y2-y1));
  <span class="hljs-keyword">var</span> ratio = (distance - config.arrowhead_length/<span class="hljs-number">3</span>) / distance;
  <span class="hljs-keyword">var</span> end_x, end_y, start_x, start_y;
  ...
  ctx.closePath();</pre></div>
        ...
        <p>calculate the angle of the line</p>
          ...
          <div class='highlight'><pre>  <span class="hljs-keyword">var</span> line_angle = <span class="hljs-built_in">Math</span>.atan2(y2 - y1, x2 - x1);</pre></div>
        ...
        <p>h is the line length of a side of the arrow head</p>
          ...
          <div class='highlight'><pre>  <span class="hljs-keyword">var</span> h = <span class="hljs-built_in">Math</span>.abs(config.arrowhead_length / <span class="hljs-built_in">Math</span>.cos(config.arrowhead_angle));

  <span class="hljs-keyword">var</span> angle1, angle2;
  <span class="hljs-keyword">var</span> top_x, top_y;
  <span class="hljs-keyword">var</span> bottom_x, bottom_y;
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">StaveLine</span> </span>{</pre></div>
...
<pre><code> {
   ...
   last_indices: [n1, n2, n3]
    ...
    <span class="hljs-keyword">this</span>.render_options = {</pre></div>
      ...
      padding_right: <span class="hljs-number">3</span>,</pre></div>
      ...
      draw_end_arrow: <span class="hljs-literal">false</span>,</pre></div>
    ...
    <span class="hljs-keyword">if</span> (!notes.first_note &amp;&amp; !notes.last_note)
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RuntimeError(<span class="hljs-string">"BadArguments"</span>,
          <span class="hljs-string">"Notes needs to have either first_note or last_note set."</span>);
    ...
    <span class="hljs-keyword">if</span> (notes.first_indices.length != notes.last_indices.length)
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RuntimeError(<span class="hljs-string">"BadArguments"</span>, <span class="hljs-string">"Connected notes must have similar"</span> +
    ...
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.context) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"NoContext"</span>,<span class="hljs-string">"No context to apply the styling to"</span>);
    }

    <span class="hljs-keyword">var</span> render_options = <span class="hljs-keyword">this</span>.render_options;
    ...
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.context) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"NoContext"</span>, <span class="hljs-string">"No context to render StaveLine."</span>);
    }
    ...
    <span class="hljs-keyword">this</span>.applyLineStyle();</pre></div>
        ...
        <p>Cycle through each set of indices and draw lines</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> start_position;
    <span class="hljs-keyword">var</span> end_position;
    <span class="hljs-keyword">this</span>.first_indices.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">first_index, i</span>) </span>{
      <span class="hljs-keyword">var</span> last_index = <span class="hljs-keyword">this</span>.last_indices[i];</pre></div>
      ...
      <span class="hljs-keyword">var</span> upwards_slope = start_position.y &gt; end_position.y;</pre></div>
        ...
        <p>Adjust <code>x</code> coordinates for modifiers</p>
          ...
          <div class='highlight'><pre>      start_position.x += first_note.getMetrics().modRightPx +
                          render_options.padding_left;
      end_position.x -= last_note.getMetrics().modLeftPx +
                        render_options.padding_right;</pre></div>
        ...
        <p>Adjust first <code>x</code> coordinates for displacements</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">var</span> notehead_width = first_note.getGlyph().head_width;
      <span class="hljs-keyword">var</span> first_displaced = first_note.getKeyProps()[first_index].displaced;
      <span class="hljs-keyword">if</span> (first_displaced &amp;&amp; first_note.getStemDirection() === <span class="hljs-number">1</span>) {
        ...
        <p>Adjust last <code>x</code> coordinates for displacements</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">var</span> last_displaced = last_note.getKeyProps()[last_index].displaced;
    ...
    ctx.restore();</pre></div>
        ...
        <p>Determine the x coordinate where to start the text</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> text_width = ctx.measureText(<span class="hljs-keyword">this</span>.text).width;
    <span class="hljs-keyword">var</span> justification = render_options.text_justification;
    ...
    <span class="hljs-keyword">if</span> (justification === StaveLine.TextJustification.LEFT) {
      ...
      <span class="hljs-keyword">var</span> delta_x = (end_position.x - start_position.x);
      <span class="hljs-keyword">var</span> center_x = (delta_x / <span class="hljs-number">2</span> ) + start_position.x;
      ...
      x = end_position.x  -  text_width;
        ...
        <p>Determine the y value to start the text</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> y;
    <span class="hljs-keyword">var</span> vertical_position = render_options.text_position_vertical;
