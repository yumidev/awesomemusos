...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">TabTie</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StaveTie</span> </span>{
  <span class="hljs-keyword">static</span> createHammeron(notes) {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> TabTie(notes, <span class="hljs-string">"H"</span>);
  }

  <span class="hljs-keyword">static</span> createPulloff(notes) {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> TabTie(notes, <span class="hljs-string">"P"</span>);
  }
  ...
  <span class="hljs-keyword">constructor</span>(notes, text) {
     ...
     *
     **/</span>
    <span class="hljs-keyword">super</span>(notes, text);
    <span class="hljs-keyword">this</span>.render_options.cp1 = <span class="hljs-number">9</span>;
    <span class="hljs-keyword">this</span>.render_options.cp2 = <span class="hljs-number">11</span>;
    <span class="hljs-keyword">this</span>.render_options.y_shift = <span class="hljs-number">3</span>;
  ...
  draw() {
    ...
    <span class="hljs-keyword">var</span> first_x_px, last_x_px, first_ys, last_ys;
    ...
    <span class="hljs-keyword">this</span>.renderTie({
      ...
      first_ys: first_ys,
      last_ys: last_ys,
      direction: <span class="hljs-number">-1</span>           <span class="hljs-comment">// Tab tie's are always face up.</span>
    });
