  ...
  <div class="container">
    <div class="page">
      ...
      <div class="header">
        ...
        <p>Vex Music Notation
Mohit Muthanna <a href="&#109;&#97;&#105;&#108;&#116;&#x6f;&#x3a;&#109;&#111;&#x68;&#105;&#116;&#x40;&#109;&#x75;&#x74;&#104;&#97;&#x6e;&#110;&#97;&#46;&#x63;&#x6f;&#109;">&#109;&#111;&#x68;&#105;&#116;&#x40;&#109;&#x75;&#x74;&#104;&#97;&#x6e;&#110;&#97;&#46;&#x63;&#x6f;&#109;</a></p>
<p>Copyright Mohit Muthanna 2010</p>

        
      
        
        <p>Bounding boxes for interactive notation</p>
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">BoundingBox</span> </span>{
  <span class="hljs-keyword">static</span> copy(that) {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> BoundingBox(that.x, that.y, that.w, that.h);
  }

  <span class="hljs-keyword">constructor</span>(x, y, w, h) {
  ...
  getY() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.y; }
  getW() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.w; }
  getH() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.h; }
  ...
  setW(w) { <span class="hljs-keyword">this</span>.w = w; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }
  setH(h) { <span class="hljs-keyword">this</span>.h = h; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }
  move(x, y) { <span class="hljs-keyword">this</span>.x += x; <span class="hljs-keyword">this</span>.y += y; }
  clone() { <span class="hljs-keyword">return</span> BoundingBox.copy(<span class="hljs-keyword">this</span>); }</pre></div>
        
      
        
        <p>Merge my box with given box. Creates a bigger bounding box unless
the given box is contained in this one.</p>

        
          <div class='highlight'><pre>  mergeWith(boundingBox, ctx) {
    <span class="hljs-keyword">var</span> that = boundingBox;

    <span class="hljs-keyword">var</span> new_x = <span class="hljs-keyword">this</span>.x &lt; that.x ? <span class="hljs-keyword">this</span>.x : that.x;
    <span class="hljs-keyword">var</span> new_y = <span class="hljs-keyword">this</span>.y &lt; that.y ? <span class="hljs-keyword">this</span>.y : that.y;
    <span class="hljs-keyword">var</span> new_w = (<span class="hljs-keyword">this</span>.x + <span class="hljs-keyword">this</span>.w) &lt; (that.x + that.w) ? (that.x + that.w) - <span class="hljs-keyword">this</span>.x : (<span class="hljs-keyword">this</span>.x + <span class="hljs-keyword">this</span>.w) - Vex.Min(<span class="hljs-keyword">this</span>.x, that.x);
    <span class="hljs-keyword">var</span> new_h = (<span class="hljs-keyword">this</span>.y + <span class="hljs-keyword">this</span>.h) &lt; (that.y + that.h) ? (that.y + that.h) - <span class="hljs-keyword">this</span>.y : (<span class="hljs-keyword">this</span>.y + <span class="hljs-keyword">this</span>.h) - Vex.Min(<span class="hljs-keyword">this</span>.y, that.y);

    <span class="hljs-keyword">this</span>.x = new_x;
    <span class="hljs-keyword">this</span>.y = new_y;
    <span class="hljs-keyword">this</span>.w = new_w;
    <span class="hljs-keyword">this</span>.h = new_h;

    <span class="hljs-keyword">if</span> (ctx) <span class="hljs-keyword">this</span>.draw(ctx);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }
  draw(ctx, x, y) {
    <span class="hljs-keyword">if</span> (!x) x = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">if</span> (!y) y = <span class="hljs-number">0</span>;
    ctx.rect(<span class="hljs-keyword">this</span>.x + x, <span class="hljs-keyword">this</span>.y + y, <span class="hljs-keyword">this</span>.w, <span class="hljs-keyword">this</span>.h);
    ctx.stroke();
  }
}</pre></div>
