...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Beam</span> </span>{</pre></div>
...
<li><code>maintain_stem_directions</code> - Set to <code>true</code> to not apply new stem directions</li>
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getTotalTicks</span>(<span class="hljs-params">vf_notes</span>)</span>{
      ...
      }, <span class="hljs-keyword">new</span> Fraction(<span class="hljs-number">0</span>, <span class="hljs-number">1</span>));
    }
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">createGroups</span>(<span class="hljs-params"></span>)</span>{
      ...
      unprocessedNotes.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">unprocessedNote</span>)</span>{
        ...
        <p>Double the amount of ticks in a group, if it’s an unbeamable tuplet</p>
          ...
          <div class='highlight'><pre>        <span class="hljs-keyword">var</span> unbeamable = Flow.durationToNumber(unprocessedNote.duration) &lt; <span class="hljs-number">8</span>;
...
the rest of the API’s style - Silverwolf90 (Cyril)</p>
    ...
    beamedNoteGroups.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">group</span>)</span>{
      <span class="hljs-keyword">var</span> beam = <span class="hljs-keyword">new</span> Beam(group);
  ...
  <span class="hljs-keyword">constructor</span>(notes, auto_stem) {
    ...
    <span class="hljs-keyword">this</span>.render_options = {
      ...
      flat_beams: <span class="hljs-literal">false</span>,
      min_flat_beam_offset: <span class="hljs-number">15</span>
    };
  }</pre></div>
...
doesn’t go crazy. To disable, set this.render_options.slope_cost = 0</p>
    ...
    <span class="hljs-keyword">this</span>.y_shift = y_shift;
        ...
        <p>Calculate a slope and y-shift for flat beams</p>
          ...
          <div class='highlight'><pre>  calculateFlatSlope() {</pre></div>
...
generate one based on the notes in this particular note group</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> total = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">var</span> extreme_y = <span class="hljs-number">0</span>;  <span class="hljs-comment">// Store the highest or lowest note here</span>
    <span class="hljs-keyword">var</span> extreme_beam_count = <span class="hljs-number">0</span>;  <span class="hljs-comment">// The beam count of the extreme note</span>
    <span class="hljs-keyword">var</span> current_extreme = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.notes.length; i++) {</pre></div>
        ...
        <p>Total up all of the offsets so we can average them out later</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">var</span> note = <span class="hljs-keyword">this</span>.notes[i];
      <span class="hljs-keyword">var</span> top_y = note.getStemExtents().topY;
      total += top_y;</pre></div>
 ...
 offset can be adjusted in case the average isn’t enough</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.stem_direction === Stem.DOWN &amp;&amp; current_extreme &lt; top_y) {
        current_extreme = top_y;
        extreme_y = note.getNoteHeadBounds().y_bottom;
        extreme_beam_count = note.getBeamCount();
      } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.stem_direction === Stem.UP &amp;&amp; (current_extreme === <span class="hljs-number">0</span> || current_extreme &gt; top_y)) {
        current_extreme = top_y;
 ...
 works for all of the notes in the beam group.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> offset = total / <span class="hljs-keyword">this</span>.notes.length;</pre></div>
 ...
 the width of the beams.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> beam_width = <span class="hljs-keyword">this</span>.render_options.beam_width * <span class="hljs-number">1.5</span>;
    <span class="hljs-keyword">var</span> extreme_test = <span class="hljs-keyword">this</span>.render_options.min_flat_beam_offset + (extreme_beam_count * beam_width);
    <span class="hljs-keyword">var</span> new_offset = extreme_y + (extreme_test * -<span class="hljs-keyword">this</span>.stem_direction);
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.stem_direction === Stem.DOWN &amp;&amp; offset &lt; new_offset) {
      offset = extreme_y + extreme_test;
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.stem_direction === Stem.UP &amp;&amp; offset &gt; new_offset) {
      offset = extreme_y - extreme_test;
    }
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.render_options.flat_beam_offset) {</pre></div>
    ...
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.stem_direction === Stem.DOWN &amp;&amp; offset &gt; <span class="hljs-keyword">this</span>.render_options.flat_beam_offset) {
      <span class="hljs-keyword">this</span>.render_options.flat_beam_offset = offset;
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.stem_direction === Stem.UP &amp;&amp; offset &lt; <span class="hljs-keyword">this</span>.render_options.flat_beam_offset) {
      <span class="hljs-keyword">this</span>.render_options.flat_beam_offset = offset;
    }</pre></div>
...
extends into the beams.</p>
    ...
    <span class="hljs-keyword">var</span> first_note = <span class="hljs-keyword">this</span>.notes[<span class="hljs-number">0</span>];
    <span class="hljs-keyword">var</span> first_y_px = first_note.getStemExtents().topY;</pre></div>
        
      
        
        <p>If rendering flat beams, and an offset exists, set the y-coordinate to
 the offset so the stems all end at the beam offset.</p>
      ...
      first_y_px = <span class="hljs-keyword">this</span>.render_options.flat_beam_offset;
    }
    <span class="hljs-keyword">var</span> first_x_px = first_note.getStemX();
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.notes.length; ++i) {
      ...
      <span class="hljs-keyword">var</span> top_y_px = y_extents.topY;</pre></div>
        ...
        <p>If flat beams, set the top of the stem to the offset, rather than
 relying on the topY value from above.</p>

        
          <div class='highlight'><pre>      <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.render_options.flat_beams) {
        top_y_px = first_y_px;
      }</pre></div>
        ...
        <p>Don’t go all the way to the top (for thicker stems)</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">var</span> y_displacement = Flow.STEM_WIDTH;
      ...
      <span class="hljs-keyword">if</span> (!note.hasStem()) {
        <span class="hljs-keyword">if</span> (note.isRest() &amp;&amp; <span class="hljs-keyword">this</span>.render_options.show_stemlets) {
          ...
          <span class="hljs-keyword">var</span> start_y = beam_y + (Stem.HEIGHT * <span class="hljs-keyword">this</span>.stem_direction);
        ...
        <p>Draw Stemlet</p>
          ...
          <div class='highlight'><pre>          note.setStem(<span class="hljs-keyword">new</span> Stem({
            x_begin: centerGlyphX,
            x_end: centerGlyphX,
            y_bottom: <span class="hljs-keyword">this</span>.stem_direction === Stem.UP ? end_y : start_y,
            y_top: <span class="hljs-keyword">this</span>.stem_direction === Stem.UP ? start_y : end_y,
      ...
      note.setStem(<span class="hljs-keyword">new</span> Stem({
        x_begin: x_px - (Flow.STEM_WIDTH/<span class="hljs-number">2</span>),
        x_end: x_px,
        y_top: <span class="hljs-keyword">this</span>.stem_direction === Stem.UP ? top_y_px : base_y_px,
        y_bottom: <span class="hljs-keyword">this</span>.stem_direction === Stem.UP ? base_y_px :  top_y_px,
        y_extend: y_displacement,
    ...
    <span class="hljs-keyword">var</span> current_beam = <span class="hljs-literal">null</span>;
    ...
    <span class="hljs-keyword">var</span> previous_should_break = <span class="hljs-literal">false</span>;
    <span class="hljs-keyword">var</span> tick_tally = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.notes.length; ++i) {
      <span class="hljs-keyword">var</span> note = <span class="hljs-keyword">this</span>.notes[i];</pre></div>
        ...
        <p>See if we need to break secondary beams on this note.</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">var</span> ticks = note.getIntrinsicTicks();
      tick_tally += ticks;
      <span class="hljs-keyword">var</span> should_break = <span class="hljs-literal">false</span>;</pre></div>
        ...
        <p>8th note beams are always drawn.</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">if</span> (<span class="hljs-built_in">parseInt</span>(duration) &gt;= <span class="hljs-number">8</span>) {</pre></div>
 ...
 handle that as well.</p>
          ...
          <div class='highlight'><pre>        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.render_options.secondary_break_ticks &amp;&amp; tick_tally &gt;= <span class="hljs-keyword">this</span>.render_options.secondary_break_ticks) {
          tick_tally = <span class="hljs-number">0</span>;
          should_break = <span class="hljs-literal">true</span>;
        }
      }
      <span class="hljs-keyword">var</span> note_gets_beam = ticks &lt; Flow.durationToTicks(duration);
 ...
 level. This will help to inform the partial beam logic below.</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">var</span> next_note = <span class="hljs-keyword">this</span>.notes[i + <span class="hljs-number">1</span>];
      <span class="hljs-keyword">var</span> beam_next = next_note &amp;&amp; next_note.getIntrinsicTicks() &lt; Flow.durationToTicks(duration);
 ...
 we need a partial pointing right.</p>
        ...
        <p>No beam started yet. Start a new one.</p>
          ...
          <div class='highlight'><pre>          current_beam = { start: stem_x, end: <span class="hljs-literal">null</span> };
 ...
 the next iteration of the loop.</p>
        ...
        <p>Add a partial beam pointing left if this is the last note in the group</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> last_beam = beam_lines[beam_lines.length - <span class="hljs-number">1</span>];
    ...
    <span class="hljs-keyword">var</span> first_y_px = first_note.getStemExtents().topY;
    <span class="hljs-keyword">var</span> last_y_px = last_note.getStemExtents().topY;</pre></div>
 ...
 using the note’s stem extents.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.render_options.flat_beams &amp;&amp; <span class="hljs-keyword">this</span>.render_options.flat_beam_offset) {
      first_y_px = <span class="hljs-keyword">this</span>.render_options.flat_beam_offset;
      last_y_px = <span class="hljs-keyword">this</span>.render_options.flat_beam_offset;
    }
    ...
    <span class="hljs-keyword">var</span> beam_width = <span class="hljs-keyword">this</span>.render_options.beam_width * <span class="hljs-keyword">this</span>.stem_direction;</pre></div>
      ...
      <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> j = <span class="hljs-number">0</span>; j &lt; beam_lines.length; ++j) {
        ...
        <span class="hljs-keyword">var</span> first_x = beam_line.start - (<span class="hljs-keyword">this</span>.stem_direction == Stem.DOWN ? Flow.STEM_WIDTH/<span class="hljs-number">2</span>:<span class="hljs-number">0</span>);
        ...
        <span class="hljs-keyword">var</span> last_x = beam_line.end +
          (<span class="hljs-keyword">this</span>.stem_direction == <span class="hljs-number">1</span> ? (Flow.STEM_WIDTH/<span class="hljs-number">3</span>):(-Flow.STEM_WIDTH/<span class="hljs-number">3</span>));
