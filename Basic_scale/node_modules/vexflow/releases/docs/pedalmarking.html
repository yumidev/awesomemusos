...
<span class="hljs-keyword">import</span> { Glyph } <span class="hljs-keyword">from</span> <span class="hljs-string">'./glyph'</span>;</pre></div>
        ...
        <p>To enable logging for this class. Set <code>Vex.Flow.PedalMarking.DEBUG</code> to <code>true</code>.</p>
          ...
          <div class='highlight'><pre><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">L</span>(<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">if</span> (PedalMarking.DEBUG) Vex.L(<span class="hljs-string">"Vex.Flow.PedalMarking"</span>, <span class="hljs-built_in">arguments</span>); }</pre></div>
...
coordinate shifts.</p>
  ...
  <span class="hljs-keyword">var</span> glyph_data = PedalMarking.GLYPHS[name];
  <span class="hljs-keyword">var</span> glyph = <span class="hljs-keyword">new</span> Glyph(glyph_data.code, point);
  glyph.render(context, x + glyph_data.x_shift, y + glyph_data.y_shift);
}

<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">PedalMarking</span> </span>{</pre></div>
    ...
    <span class="hljs-keyword">return</span> {
      ...
      <span class="hljs-string">"pedal_release"</span>: {
        ...
        x_shift:<span class="hljs-number">-2</span>,
  ...
  <span class="hljs-keyword">static</span> get Styles() {
    <span class="hljs-keyword">return</span> {
      ...
      BRACKET: <span class="hljs-number">2</span>,
      MIXED: <span class="hljs-number">3</span>
    };
  }</pre></div>
...
Which uses the traditional “Ped” and “*”” markings.</p>
    ...
    <span class="hljs-keyword">var</span> pedal = <span class="hljs-keyword">new</span> PedalMarking(notes);
    ...
    <span class="hljs-keyword">this</span>.font = {
      family: <span class="hljs-string">"Times New Roman"</span>,
      size: <span class="hljs-number">12</span>,
      weight: <span class="hljs-string">"italic bold"</span>
    };

    <span class="hljs-keyword">this</span>.render_options = {
      bracket_height: <span class="hljs-number">10</span>,
      text_margin_right: <span class="hljs-number">6</span>,
      bracket_line_width: <span class="hljs-number">1</span>,
      glyph_point_size: <span class="hljs-number">40</span>,
...
set if the parameter is falsy.</p>
    ...
    <span class="hljs-keyword">if</span> (style &lt; <span class="hljs-number">1</span> &amp;&amp; style &gt; <span class="hljs-number">3</span>)  {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"InvalidParameter"</span>,
        <span class="hljs-string">"The style must be one found in PedalMarking.Styles"</span>);
    }
    ...
    <span class="hljs-keyword">var</span> is_pedal_depressed = <span class="hljs-literal">false</span>;
    <span class="hljs-keyword">var</span> prev_x;
    <span class="hljs-keyword">var</span> prev_y;
    <span class="hljs-keyword">var</span> pedal = <span class="hljs-keyword">this</span>;</pre></div>
        ...
        <p>Iterate through each note</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.notes.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">note, index, notes</span>) </span>{</pre></div>
        ...
        <p>Get the initial coordinates for the note</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">var</span> x = note.getAbsoluteX();
      <span class="hljs-keyword">var</span> y = note.getStave().getYForBottomText(pedal.line + <span class="hljs-number">3</span>);</pre></div>
        ...
        <p>Throw if current note is positioned before the previous note</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">if</span> (x &lt; prev_x) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">'InvalidConfiguration'</span>,
        <span class="hljs-string">'The notes provided must be in order of ascending x positions'</span>);</pre></div>
...
when adjustments are made for the release+depress action</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">var</span> next_is_same = notes[index+<span class="hljs-number">1</span>] === note;
      <span class="hljs-keyword">var</span> prev_is_same = notes[index<span class="hljs-number">-1</span>] === note;
      ...
      <span class="hljs-keyword">if</span> (is_pedal_depressed) {</pre></div>
        ...
        <p>If we have custom text, use instead of the default “Ped” glyph</p>
          ...
          <div class='highlight'><pre>            <span class="hljs-keyword">var</span> text_width = ctx.measureText(pedal.custom_depress_text).width;
...
“Ped” and “*”” symbols if no custom text has been provided.</p>
    ...
    <span class="hljs-keyword">var</span> pedal = <span class="hljs-keyword">this</span>;</pre></div>
        ...
        <p>The glyph point size</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> point = pedal.render_options.glyph_point_size;</pre></div>
        ...
        <p>Iterate through each note, placing glyphs or custom text accordingly</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.notes.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">note</span>) </span>{
      is_pedal_depressed = !is_pedal_depressed;
      <span class="hljs-keyword">var</span> stave = note.getStave();
      <span class="hljs-keyword">var</span> x = note.getAbsoluteX();
      <span class="hljs-keyword">var</span> y = stave.getYForBottomText(pedal.line + <span class="hljs-number">3</span>);

      <span class="hljs-keyword">var</span> text_width = <span class="hljs-number">0</span>;
    ...
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.context) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"NoContext"</span>,
      <span class="hljs-string">"Can't draw PedalMarking without a context."</span>);
    <span class="hljs-keyword">var</span> ctx = <span class="hljs-keyword">this</span>.context;
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.style === PedalMarking.Styles.BRACKET ||
        <span class="hljs-keyword">this</span>.style === PedalMarking.Styles.MIXED) {
