...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">TabStave</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">Stave</span> </span>{
  <span class="hljs-keyword">constructor</span>(x, y, width, options) {
    <span class="hljs-keyword">var</span> tab_options = {
      spacing_between_lines_px: <span class="hljs-number">13</span>,
      num_lines: <span class="hljs-number">6</span>,
      top_text_position: <span class="hljs-number">1</span>
    };

    Vex.Merge(tab_options, options);
    <span class="hljs-keyword">super</span>(x, y, width, tab_options);
  }

  getYForGlyphs() {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.getYForLine(<span class="hljs-number">2.5</span>);
  }</pre></div>
        ...
        <p>Deprecated</p>
          ...
          <div class='highlight'><pre>  addTabGlyph() {
    <span class="hljs-keyword">this</span>.addClef(<span class="hljs-string">'tab'</span>);
