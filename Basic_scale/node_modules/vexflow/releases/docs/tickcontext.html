...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">TickContext</span> </span>{
  <span class="hljs-keyword">static</span> getNextContext(tContext) {
    <span class="hljs-keyword">var</span> contexts = tContext.tContexts;
    <span class="hljs-keyword">var</span> index = contexts.indexOf(tContext);
  ...
  <span class="hljs-keyword">constructor</span>() {
    ...
    <span class="hljs-keyword">this</span>.minTicks = <span class="hljs-literal">null</span>;
    <span class="hljs-keyword">this</span>.width = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">this</span>.padding = <span class="hljs-number">3</span>;     <span class="hljs-comment">// padding on each side (width += padding * 2)</span>
    <span class="hljs-keyword">this</span>.pixelsUsed = <span class="hljs-number">0</span>;
    ...
    <span class="hljs-keyword">this</span>.notePx = <span class="hljs-number">0</span>;       <span class="hljs-comment">// width of widest note in this context</span>
    <span class="hljs-keyword">this</span>.extraLeftPx = <span class="hljs-number">0</span>;  <span class="hljs-comment">// Extra left pixels for modifers &amp; displace notes</span>
    <span class="hljs-keyword">this</span>.extraRightPx = <span class="hljs-number">0</span>; <span class="hljs-comment">// Extra right pixels for modifers &amp; displace notes</span>
    <span class="hljs-keyword">this</span>.align_center = <span class="hljs-literal">false</span>;

    <span class="hljs-keyword">this</span>.tContexts = [];   <span class="hljs-comment">// Parent array of tick contexts</span></pre></div>
        
      
        
        <p>Ignore this tick context for formatting and justification</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.ignore_ticks = <span class="hljs-literal">true</span>;
    ...
    <span class="hljs-keyword">this</span>.context = <span class="hljs-literal">null</span>; <span class="hljs-comment">// Rendering context</span>
  }
  ...
  setX(x) { <span class="hljs-keyword">this</span>.x = x; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }
  getPixelsUsed() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.pixelsUsed; }
  setPixelsUsed(pixelsUsed) { <span class="hljs-keyword">this</span>.pixelsUsed = pixelsUsed; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }
  ...
  getCenterAlignedTickables() {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.tickables.filter(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">tickable</span>) </span>{
      <span class="hljs-keyword">return</span> tickable.isCenterAligned();
    });
  }</pre></div>
    ...
    <span class="hljs-keyword">return</span> { width: <span class="hljs-keyword">this</span>.width, notePx: <span class="hljs-keyword">this</span>.notePx,
             extraLeftPx: <span class="hljs-keyword">this</span>.extraLeftPx, extraRightPx: <span class="hljs-keyword">this</span>.extraRightPx };
  }
  ...
  setCurrentTick(tick) {
    ...
    <span class="hljs-keyword">this</span>.preFormatted = <span class="hljs-literal">false</span>;
        ...
        <p>Get left &amp; right pixels used for modifiers</p>

        
          <div class='highlight'><pre>  getExtraPx() {
    <span class="hljs-keyword">var</span> left_shift = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">var</span> right_shift = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">var</span> extraLeftPx = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">var</span> extraRightPx = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.tickables.length; i++) {
      extraLeftPx = <span class="hljs-built_in">Math</span>.max(<span class="hljs-keyword">this</span>.tickables[i].extraLeftPx, extraLeftPx);
      extraRightPx = <span class="hljs-built_in">Math</span>.max(<span class="hljs-keyword">this</span>.tickables[i].extraRightPx, extraRightPx);
      <span class="hljs-keyword">var</span> mContext = <span class="hljs-keyword">this</span>.tickables[i].modifierContext;
      <span class="hljs-keyword">if</span> (mContext &amp;&amp; mContext != <span class="hljs-literal">null</span>) {
        left_shift = <span class="hljs-built_in">Math</span>.max( left_shift, mContext.state.left_shift);
        right_shift = <span class="hljs-built_in">Math</span>.max( right_shift, mContext.state.right_shift);
      }
    }
    <span class="hljs-keyword">return</span> { left: left_shift, right: right_shift,
  ...
  addTickable(tickable) {
    ...
    <span class="hljs-keyword">if</span> (!tickable.shouldIgnoreTicks()) {
      ...
      <span class="hljs-keyword">var</span> ticks = tickable.getTicks();
  ...
  preFormat() {
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.tickables.length; ++i) {
      <span class="hljs-keyword">var</span> tickable = <span class="hljs-keyword">this</span>.tickables[i];
      tickable.preFormat();
      <span class="hljs-keyword">var</span> metrics = tickable.getMetrics();</pre></div>
        
      
        
        <p>Maintain max extra pixels from all tickables in the context</p>

        
          <div class='highlight'><pre>      <span class="hljs-keyword">this</span>.extraLeftPx = <span class="hljs-built_in">Math</span>.max(<span class="hljs-keyword">this</span>.extraLeftPx,
                                  metrics.extraLeftPx + metrics.modLeftPx);
      <span class="hljs-keyword">this</span>.extraRightPx = <span class="hljs-built_in">Math</span>.max(<span class="hljs-keyword">this</span>.extraRightPx,
                                   metrics.extraRightPx + metrics.modRightPx);</pre></div>
        ...
        <p>Maintain the widest note for all tickables in the context</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">this</span>.notePx = <span class="hljs-built_in">Math</span>.max(<span class="hljs-keyword">this</span>.notePx, metrics.noteWidth);</pre></div>
        ...
        <p>Recalculate the tick context total width</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">this</span>.width = <span class="hljs-keyword">this</span>.notePx +
                   <span class="hljs-keyword">this</span>.extraLeftPx +
                   <span class="hljs-keyword">this</span>.extraRightPx;
    }
