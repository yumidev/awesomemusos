...
<span class="hljs-keyword">import</span> { Glyph } <span class="hljs-keyword">from</span> <span class="hljs-string">'./glyph'</span>;</pre></div>
        ...
        <p>To enable logging for this class. Set <code>Vex.Flow.StaveNote.DEBUG</code> to <code>true</code>.</p>
          ...
          <div class='highlight'><pre><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">L</span>(<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">if</span> (StaveNote.DEBUG) Vex.L(<span class="hljs-string">"Vex.Flow.StaveNote"</span>, <span class="hljs-built_in">arguments</span>); }</pre></div>
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">StaveNote</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StemmableNote</span> </span>{
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'stavenotes'</span>; }</pre></div>
        ...
        <p>Stem directions</p>
          ...
          <div class='highlight'><pre>  <span class="hljs-keyword">static</span> get STEM_UP() {
    <span class="hljs-keyword">return</span> Stem.UP;
  }
  <span class="hljs-keyword">static</span> get STEM_DOWN() {
...
<p>Special case 1 :: middle voice rest between two notes</p>
  ...
  <span class="hljs-keyword">static</span> formatByY(notes, state) {</pre></div>
    ...
    <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>; i &lt; notes.length - <span class="hljs-number">1</span>; i++) {
      ...
      <span class="hljs-keyword">if</span> (top_note.getStemDirection() == StaveNote.STEM_DOWN) {
...
are correctly displaced.</p>
      ...
      <span class="hljs-keyword">this</span>.note_heads[i] = note_head;
        ...
        <p>Automatically sets the stem direction based on the keys in the note</p>
          ...
          <div class='highlight'><pre>  autoStem() {
...
if (this.glyph.rest) key = this.glyph.position;</p>
      ...
      <span class="hljs-keyword">var</span> props = Flow.keyProperties(key, <span class="hljs-keyword">this</span>.clef, options);
...
displaced as well, for modifier placement</p>
      ...
      <span class="hljs-keyword">this</span>.keyProps.push(props);
        ...
        <p>Sort the notes from lowest line to highest line</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> sorted = <span class="hljs-literal">true</span>;
    <span class="hljs-keyword">var</span> lastLine = <span class="hljs-number">-1000</span>;
    <span class="hljs-keyword">var</span> that = <span class="hljs-keyword">this</span>;
    <span class="hljs-keyword">this</span>.keyProps.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">key</span>) </span>{
      <span class="hljs-keyword">if</span> (key.line &lt; lastLine) {
        Vex.W(<span class="hljs-string">"Unsorted keys in note will be sorted. "</span> +
          <span class="hljs-string">"See https://github.com/0xfe/vexflow/issues/104 for details."</span>);
      }
      lastLine = key.line;
    });
    <span class="hljs-keyword">this</span>.keyProps.sort(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">a, b</span>) </span>{ <span class="hljs-keyword">return</span> a.line - b.line; });
  }</pre></div>
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> BoundingBox(x, min_y, w, max_y - min_y);
  }</pre></div>
...
If <code>is_top_note</code> is <code>true</code> then get the top note</p>
          ...
          <div class='highlight'><pre>  getLineNumber(is_top_note) {
    ...
    <span class="hljs-keyword">var</span> result_line = <span class="hljs-keyword">this</span>.keyProps[<span class="hljs-number">0</span>].line;</pre></div>
      ...
      <span class="hljs-keyword">if</span> (is_top_note) {
        <span class="hljs-keyword">if</span> (this_line &gt; result_line) result_line = this_line;
      } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">if</span> (this_line &lt; result_line) result_line = this_line;
      }
    }
    ...
    <span class="hljs-keyword">return</span> result_line;
        ...
        <p>Determine if the <code>StaveNote</code> has a stem</p>
          ...
          <div class='highlight'><pre>  hasStem() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.glyph.stem; }</pre></div>
...
and key <code>index</code></p>
    ...
    <span class="hljs-keyword">if</span> (position == Modifier.Position.LEFT) {</pre></div>
    ...
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (position == Modifier.Position.RIGHT) {</pre></div>
    ...
    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (position == Modifier.Position.BELOW ||
...
and the stem.</p>
    ...
    <span class="hljs-keyword">this</span>.note_heads.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">notehead</span>) </span>{
...
if the note is displaced.</p>
    ...
    <span class="hljs-keyword">this</span>.setExtraLeftPx((<span class="hljs-keyword">this</span>.displaced &amp;&amp; <span class="hljs-keyword">this</span>.stem_direction == <span class="hljs-number">-1</span>) ?
        <span class="hljs-keyword">this</span>.glyph.head_width : <span class="hljs-number">0</span>);</pre></div>
...
up by the flag.</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.setExtraRightPx((!<span class="hljs-keyword">this</span>.hasFlag() &amp;&amp; <span class="hljs-keyword">this</span>.displaced &amp;&amp; <span class="hljs-keyword">this</span>.stem_direction == <span class="hljs-number">1</span>) ?
    ...
    <span class="hljs-keyword">return</span> x_begin + <span class="hljs-keyword">this</span>.glyph.head_width - (Flow.STEM_WIDTH / <span class="hljs-number">2</span>);
  }</pre></div>
    ...
    <span class="hljs-keyword">if</span> (glyph.flag &amp;&amp; render_flag) {
      ...
      <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.getStemDirection() === Stem.DOWN) {</pre></div>
        ...
        <p>Draw the Flag</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">this</span>.context.openGroup(<span class="hljs-string">"flag"</span>, <span class="hljs-literal">null</span>, {pointerBBox: <span class="hljs-literal">true</span>});
    ...
    <span class="hljs-keyword">var</span> that = <span class="hljs-keyword">this</span>;
    <span class="hljs-keyword">this</span>.note_heads.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">note_head</span>) </span>{
      that.context.openGroup(<span class="hljs-string">"notehead"</span>, <span class="hljs-literal">null</span>, {pointerBBox: <span class="hljs-literal">true</span>});
    ...
    <span class="hljs-keyword">this</span>.elem = <span class="hljs-keyword">this</span>.context.openGroup(<span class="hljs-string">"stavenote"</span>, <span class="hljs-keyword">this</span>.id);
