...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">GraceNote</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StaveNote</span> </span>{
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'gracenotes'</span>; }

  <span class="hljs-keyword">constructor</span>(note_struct) {
    <span class="hljs-keyword">super</span>(note_struct);

    <span class="hljs-keyword">this</span>.render_options.glyph_font_scale = <span class="hljs-number">22</span>;
    <span class="hljs-keyword">this</span>.render_options.stem_height = <span class="hljs-number">20</span>;
    <span class="hljs-keyword">this</span>.render_options.stroke_px = <span class="hljs-number">2</span>;
    <span class="hljs-keyword">this</span>.glyph.head_width = <span class="hljs-number">6</span>;

    <span class="hljs-keyword">this</span>.slash = note_struct.slash;
    <span class="hljs-keyword">this</span>.slur = <span class="hljs-literal">true</span>;
  ...
  getStemExtension(){
    ...
    <span class="hljs-keyword">if</span> (glyph) {
      <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.getStemDirection() === <span class="hljs-number">1</span> ? glyph.gracenote_stem_up_extension :
  ...
  getCategory() { <span class="hljs-keyword">return</span> GraceNote.CATEGORY; }
  ...
  draw(){
    ...
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.slash) {
      ctx.beginPath();

      <span class="hljs-keyword">var</span> x = <span class="hljs-keyword">this</span>.getAbsoluteX();
      <span class="hljs-keyword">var</span> y = <span class="hljs-keyword">this</span>.getYs()[<span class="hljs-number">0</span>] - (<span class="hljs-keyword">this</span>.stem.getHeight() / <span class="hljs-number">2.8</span>);
      <span class="hljs-keyword">if</span> (stem_direction === <span class="hljs-number">1</span>) {
        x += <span class="hljs-number">1</span>;
        ctx.moveTo(x, y);
        ctx.lineTo(x + <span class="hljs-number">13</span>, y - <span class="hljs-number">9</span>);
      } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (stem_direction === <span class="hljs-number">-1</span>) {
