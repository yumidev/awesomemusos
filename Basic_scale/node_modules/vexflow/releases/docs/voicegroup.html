...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">VoiceGroup</span> </span>{
  <span class="hljs-keyword">constructor</span>() {
    <span class="hljs-keyword">this</span>.voices = [];
    <span class="hljs-keyword">this</span>.modifierContexts = [];
  }</pre></div>
...
and preformatters to associate them with the right modifierContexts.</p>
          ...
          <div class='highlight'><pre>  getVoices() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.voices; }
  getModifierContexts() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.modifierContexts; }

  addVoice(voice) {
    <span class="hljs-keyword">if</span> (!voice) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"BadArguments"</span>, <span class="hljs-string">"Voice cannot be null."</span>);
    <span class="hljs-keyword">this</span>.voices.push(voice);
    voice.setVoiceGroup(<span class="hljs-keyword">this</span>);
  }
}</pre></div>
