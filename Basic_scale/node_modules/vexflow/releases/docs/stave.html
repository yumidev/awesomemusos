...
<span class="hljs-keyword">const</span> THICKNESS = (Flow.STAVE_LINE_THICKNESS &gt; <span class="hljs-number">1</span> ?
      Flow.STAVE_LINE_THICKNESS : <span class="hljs-number">0</span>);

<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Stave</span> </span>{
  <span class="hljs-keyword">constructor</span>(x, y, width, options) {
    ...
    <span class="hljs-keyword">this</span>.options = {
      ...
      left_bar: <span class="hljs-literal">true</span>,               <span class="hljs-comment">// draw vertical bar on left</span>
    ...
    <span class="hljs-keyword">var</span> BARTYPE = Barline.type;
    <span class="hljs-keyword">this</span>.addModifier(<span class="hljs-keyword">new</span> Barline(<span class="hljs-keyword">this</span>.options.left_bar ? BARTYPE.SINGLE : BARTYPE.NONE));  <span class="hljs-comment">// beg bar</span>
    <span class="hljs-keyword">this</span>.addEndModifier(<span class="hljs-keyword">new</span> Barline(<span class="hljs-keyword">this</span>.options.right_bar ? BARTYPE.SINGLE : BARTYPE.NONE)); <span class="hljs-comment">// end bar</span>
  }
  ...
  setX(x){
    <span class="hljs-keyword">var</span> shift = x - <span class="hljs-keyword">this</span>.x;
    <span class="hljs-keyword">this</span>.formatted = <span class="hljs-literal">false</span>;
    <span class="hljs-keyword">this</span>.x = x;
...
this.modifiers[1].setX(this.end_x);</p>
  ...
  getModifierXShift(index) {
    ...
    <span class="hljs-keyword">var</span> start_x = <span class="hljs-keyword">this</span>.start_x - <span class="hljs-keyword">this</span>.x;
    <span class="hljs-keyword">var</span> begBarline = <span class="hljs-keyword">this</span>.modifiers[<span class="hljs-number">0</span>];
    <span class="hljs-keyword">if</span> (begBarline.getType() === Barline.type.REPEAT_BEGIN &amp;&amp;
  ...
  getBoundingBox() {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> BoundingBox(<span class="hljs-keyword">this</span>.x, <span class="hljs-keyword">this</span>.y, <span class="hljs-keyword">this</span>.width, <span class="hljs-keyword">this</span>.getBottomY() - <span class="hljs-keyword">this</span>.y);</pre></div>
  ...
  getLineForY(y){</pre></div>
        ...
        <p>Does the revers of getYForLine - somewhat dumb and just calls getYForLine until the right value is reaches</p>
    ...
    <span class="hljs-keyword">var</span> spacing = options.spacing_between_lines_px;
    <span class="hljs-keyword">var</span> headroom = options.space_above_staff_ln;
    <span class="hljs-keyword">return</span> ((y - <span class="hljs-keyword">this</span>.y + (THICKNESS / <span class="hljs-number">2</span>)) / spacing) - headroom;
  }
  ...
  addEndModifier(modifier) {
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
        ...
        <p>Only valid bar types at beginning of stave is none, single or begin repeat</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">if</span> (type == Barline.type.SINGLE ||
  ...
  setClef(clefSpec, size, annotation, position) {
    ...
    <span class="hljs-keyword">var</span> clefs = <span class="hljs-keyword">this</span>.getModifiers(position, Clef.CATEGORY);
  ...
  setKeySignature(keySpec, cancelKeySpec, position) {
    ...
    <span class="hljs-keyword">var</span> keySignatures = <span class="hljs-keyword">this</span>.getModifiers(position, KeySignature.CATEGORY);
  ...
  setTimeSignature(timeSpec, customPadding, position) {
    ...
    <span class="hljs-keyword">var</span> timeSignatures = <span class="hljs-keyword">this</span>.getModifiers(position, TimeSignature.CATEGORY);
  ...
  addKeySignature(keySpec, cancelKeySpec, position) {
    <span class="hljs-keyword">this</span>.addModifier(<span class="hljs-keyword">new</span> KeySignature(keySpec, cancelKeySpec), position);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }
  ...
  getModifiers(position, category) {
    <span class="hljs-keyword">if</span> (position === <span class="hljs-literal">undefined</span>) <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.modifiers;

    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.modifiers.filter(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">modifier</span>) </span>{
      <span class="hljs-keyword">return</span> position === modifier.getPosition() &amp;&amp;
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = items.length - <span class="hljs-number">1</span>; i &gt;= <span class="hljs-number">0</span>; i--) {
      <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> j = <span class="hljs-number">0</span>; j &lt; i; j++) {
        <span class="hljs-keyword">if</span> (order[items[j].getCategory()] &gt; order[items[j + <span class="hljs-number">1</span>].getCategory()]) {
          <span class="hljs-keyword">var</span> temp = items[j];
  ...
  format() {
    <span class="hljs-keyword">var</span> begBarline = <span class="hljs-keyword">this</span>.modifiers[<span class="hljs-number">0</span>];
    <span class="hljs-keyword">var</span> endBarline = <span class="hljs-keyword">this</span>.modifiers[<span class="hljs-number">1</span>];

    <span class="hljs-keyword">var</span> begModifiers = <span class="hljs-keyword">this</span>.getModifiers(StaveModifier.Position.BEGIN);
    <span class="hljs-keyword">var</span> endModifiers = <span class="hljs-keyword">this</span>.getModifiers(StaveModifier.Position.END);

    <span class="hljs-keyword">this</span>.sortByCategory(begModifiers, {
      barlines: <span class="hljs-number">0</span>, clefs: <span class="hljs-number">1</span>, keysignatures: <span class="hljs-number">2</span>, timesignatures: <span class="hljs-number">3</span>
    });

    <span class="hljs-keyword">this</span>.sortByCategory(endModifiers, {
      timesignatures: <span class="hljs-number">0</span>, keysignatures: <span class="hljs-number">1</span>, barlines: <span class="hljs-number">2</span>, clefs: <span class="hljs-number">3</span>
    });
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; begModifiers.length; i++) {
    ...
    <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>; i &lt; endModifiers.length; i++) {
    ...
    <span class="hljs-keyword">this</span>.end_x = endModifiers.length === <span class="hljs-number">1</span> ? <span class="hljs-keyword">this</span>.x + <span class="hljs-keyword">this</span>.width : x;
  ...
  draw() {
    ...
    <span class="hljs-keyword">var</span> x = <span class="hljs-keyword">this</span>.x;
    <span class="hljs-keyword">var</span> y;</pre></div>
      ...
      <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.options.line_config[line].visible) {
        <span class="hljs-keyword">this</span>.context.fillRect(x, y, width, Flow.STAVE_LINE_THICKNESS);
      }
      <span class="hljs-keyword">this</span>.context.restore();
        ...
        <p>Draw the modifiers (bar lines, coda, segno, repeat brackets, etc.)</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.modifiers.length; i++) {</pre></div>
...
Do not delete - draws the beginning bar of the stave</p>
          ...
          <div class='highlight'><pre>  drawVertical(x, isDouble) {
