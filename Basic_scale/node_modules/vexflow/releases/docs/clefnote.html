...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">ClefNote</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">Note</span> </span>{
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'clefnote'</span>; }

  <span class="hljs-keyword">constructor</span>(type, size, annotation) {
    <span class="hljs-keyword">super</span>({ duration: <span class="hljs-string">'b'</span> });

    <span class="hljs-keyword">this</span>.setType(type, size, annotation);</pre></div>
  ...
  setType(type, size, annotation) {
    ...
    <span class="hljs-keyword">this</span>.clef_obj = <span class="hljs-keyword">new</span> Clef(type, size, annotation);
    <span class="hljs-keyword">this</span>.clef = <span class="hljs-keyword">this</span>.clef_obj.clef;
    <span class="hljs-keyword">this</span>.glyph = <span class="hljs-keyword">new</span> Glyph(<span class="hljs-keyword">this</span>.clef.code, <span class="hljs-keyword">this</span>.clef.point);
    <span class="hljs-keyword">this</span>.setWidth(<span class="hljs-keyword">this</span>.glyph.getMetrics().width);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }

  getClef() {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.clef;
  }

  setContext(context){
    <span class="hljs-keyword">this</span>.context = context;
    <span class="hljs-keyword">this</span>.glyph.setContext(<span class="hljs-keyword">this</span>.context);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }
  ...
  getCategory() { <span class="hljs-keyword">return</span> ClefNote.CATEGORY; }
  ...
  draw() {
    ...
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.glyph.getContext()) {
      <span class="hljs-keyword">this</span>.glyph.setContext(<span class="hljs-keyword">this</span>.context);
    }
    <span class="hljs-keyword">var</span> abs_x = <span class="hljs-keyword">this</span>.getAbsoluteX();

    <span class="hljs-keyword">this</span>.glyph.setStave(<span class="hljs-keyword">this</span>.stave);
    <span class="hljs-keyword">this</span>.glyph.setYShift(
      <span class="hljs-keyword">this</span>.stave.getYForLine(<span class="hljs-keyword">this</span>.clef.line) - <span class="hljs-keyword">this</span>.stave.getYForGlyphs());
    <span class="hljs-keyword">this</span>.glyph.renderToStave(abs_x);</pre></div>
        
      
        
        <p>If the Vex.Flow.Clef has an annotation, such as 8va, draw it.</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.clef_obj.annotation !== <span class="hljs-literal">undefined</span>) {
      <span class="hljs-keyword">var</span> attachment = <span class="hljs-keyword">new</span> Glyph(<span class="hljs-keyword">this</span>.clef_obj.annotation.code, <span class="hljs-keyword">this</span>.clef_obj.annotation.point);
      <span class="hljs-keyword">if</span> (!attachment.getContext()) {
          attachment.setContext(<span class="hljs-keyword">this</span>.context);
      }
      attachment.setStave(<span class="hljs-keyword">this</span>.stave);
      attachment.setYShift(
        <span class="hljs-keyword">this</span>.stave.getYForLine(<span class="hljs-keyword">this</span>.clef_obj.annotation.line) - <span class="hljs-keyword">this</span>.stave.getYForGlyphs());
      attachment.setXShift(<span class="hljs-keyword">this</span>.clef_obj.annotation.x_shift);
