...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">StaveSection</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StaveModifier</span> </span>{
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'stavesection'</span>; }

  <span class="hljs-keyword">constructor</span>(section, x, shift_y) {
    ...
    <span class="hljs-keyword">this</span>.shift_x = <span class="hljs-number">0</span>;
  ...
  getCategory() { <span class="hljs-keyword">return</span> StaveSection.CATEGORY; }
  setStaveSection(section) { <span class="hljs-keyword">this</span>.section = section; <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; }
  ...
  draw(stave, shift_x) {
    <span class="hljs-keyword">if</span> (!stave.context) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"NoContext"</span>,
      <span class="hljs-string">"Can't draw stave section without a context."</span>);
    ...
    <span class="hljs-keyword">var</span> text_width = ctx.measureText(<span class="hljs-string">""</span> + <span class="hljs-keyword">this</span>.section).width;
    <span class="hljs-keyword">var</span> width = text_width + <span class="hljs-number">6</span>;  <span class="hljs-comment">// add left &amp; right padding</span>
    <span class="hljs-keyword">if</span> (width &lt; <span class="hljs-number">18</span>) width = <span class="hljs-number">18</span>;
    <span class="hljs-keyword">var</span> height = <span class="hljs-number">20</span>;</pre></div>
        
      
        
        <p> Seems to be a good default y</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">var</span> y = stave.getYForTopText(<span class="hljs-number">3</span>) + <span class="hljs-keyword">this</span>.shift_y;
    <span class="hljs-keyword">var</span> x = <span class="hljs-keyword">this</span>.x + shift_x;
    ctx.beginPath();
    ctx.lineWidth = <span class="hljs-number">2</span>;
    ctx.rect(x, y, width, height);
    ctx.stroke();
    x += (width - text_width) / <span class="hljs-number">2</span>;
    ctx.fillText(<span class="hljs-string">""</span> + <span class="hljs-keyword">this</span>.section, x, y + <span class="hljs-number">16</span>);
    ctx.restore();
