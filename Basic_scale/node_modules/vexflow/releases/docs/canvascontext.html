...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">CanvasContext</span> </span>{
  <span class="hljs-keyword">static</span> get WIDTH() {
  ...
  <span class="hljs-keyword">constructor</span>(context) {</pre></div>
...
property</p>
  ...
  setLineCap(cap_type) {
    ...
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
        ...
        <p>setLineDash: is the one native method in a canvas context
...
expected.</p>
          ...
          <div class='highlight'><pre>  setLineDash(dash){
