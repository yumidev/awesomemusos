...
<html>
<head>
  <title>modifiercontext.js</title>
...
<p>This class implements various types of modifiers to notes (e.g. bends,
fingering positions etc.)</p>
...
<span class="hljs-keyword">import</span> { Vibrato } <span class="hljs-keyword">from</span> <span class="hljs-string">'./vibrato'</span>;</pre></div>
        
      
        
        <p>To enable logging for this class. Set <code>Vex.Flow.ModifierContext.DEBUG</code> to <code>true</code>.</p>

        
          <div class='highlight'><pre><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">L</span>(<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">if</span> (ModifierContext.DEBUG) Vex.L(<span class="hljs-string">"Vex.Flow.ModifierContext"</span>, <span class="hljs-built_in">arguments</span>); }

<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">ModifierContext</span> </span>{
  <span class="hljs-keyword">constructor</span>() {</pre></div>
        
      
        
        <p>Current modifiers</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.modifiers = {};</pre></div>
    ...
    <span class="hljs-keyword">this</span>.spacing = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">this</span>.state = {
      left_shift: <span class="hljs-number">0</span>,
      right_shift: <span class="hljs-number">0</span>,
      text_line: <span class="hljs-number">0</span>,
      top_text_line: <span class="hljs-number">0</span>
    };</pre></div>
        
      
        
        <p>Add new modifiers to this array. The ordering is significant – lower
modifiers are formatted and rendered before higher ones.</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.PREFORMAT = [
      StaveNote,
      Dot,
      FretHandFinger,
      Accidental,
      ...
      Vibrato
        ...
        <p>If post-formatting is required for an element, add it to this array.</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.POSTFORMAT = [ StaveNote ];
  }

  addModifier(modifier) {
    <span class="hljs-keyword">var</span> type = modifier.getCategory();
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.modifiers[type]) <span class="hljs-keyword">this</span>.modifiers[type] = [];
    <span class="hljs-keyword">this</span>.modifiers[type].push(modifier);
    modifier.setModifierContext(<span class="hljs-keyword">this</span>);
    <span class="hljs-keyword">this</span>.preFormatted = <span class="hljs-literal">false</span>;
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }

  getModifiers(type) { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.modifiers[type]; }
  getWidth() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.width; }
  getExtraLeftPx() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.state.left_shift; }
  getExtraRightPx() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.state.right_shift; }
  getState() { <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.state; }

  getMetrics() {
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.formatted) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">"UnformattedModifier"</span>,
        <span class="hljs-string">"Unformatted modifier has no metrics."</span>);

    <span class="hljs-keyword">return</span> {
      width: <span class="hljs-keyword">this</span>.state.left_shift + <span class="hljs-keyword">this</span>.state.right_shift + <span class="hljs-keyword">this</span>.spacing,
      spacing: <span class="hljs-keyword">this</span>.spacing,
      extra_left_px: <span class="hljs-keyword">this</span>.state.left_shift,
      extra_right_px: <span class="hljs-keyword">this</span>.state.right_shift
    };
  }

  preFormat() {
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.preFormatted) <span class="hljs-keyword">return</span>;
    <span class="hljs-keyword">this</span>.PREFORMAT.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">modifier</span>) </span>{
      L(<span class="hljs-string">"Preformatting ModifierContext: "</span>, modifier.CATEGORY);
      modifier.format(<span class="hljs-keyword">this</span>.getModifiers(modifier.CATEGORY), <span class="hljs-keyword">this</span>.state, <span class="hljs-keyword">this</span>);
    }, <span class="hljs-keyword">this</span>);</pre></div>
        
      
        
        <p>Update width of this modifier context</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.width = <span class="hljs-keyword">this</span>.state.left_shift + <span class="hljs-keyword">this</span>.state.right_shift;
  ...
  postFormat() {
    ...
    <span class="hljs-keyword">this</span>.POSTFORMAT.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">modifier</span>) </span>{
      L(<span class="hljs-string">"Postformatting ModifierContext: "</span>, modifier.CATEGORY);
      modifier.postFormat(<span class="hljs-keyword">this</span>.getModifiers(modifier.CATEGORY), <span class="hljs-keyword">this</span>);
