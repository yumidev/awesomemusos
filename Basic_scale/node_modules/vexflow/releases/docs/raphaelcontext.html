...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">RaphaelContext</span> </span>{
  <span class="hljs-keyword">constructor</span>(element) {
    ...
    <span class="hljs-keyword">this</span>.paper = Raphael(element);
    ...
    <span class="hljs-keyword">this</span>.state = {
      ...
      font_weight: <span class="hljs-number">800</span>
    };
  ...
  scale(x, y) {
    <span class="hljs-keyword">this</span>.state.scale = { x: x, y: y };</pre></div>
...
arc method.</p>
  ...
  arcHelper(x, y, radius, startAngle, endAngle, antiClockwise) {
    ...
    <span class="hljs-keyword">var</span> out = <span class="hljs-keyword">this</span>.paper.set();
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.shadow_attributes.width &gt; <span class="hljs-number">0</span>) {
      ...
      <span class="hljs-keyword">var</span> num_paths = sa.width / <span class="hljs-number">2</span>;
      <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">1</span>; i &lt;= num_paths; i++) {
        out.push(<span class="hljs-keyword">this</span>.paper.path(<span class="hljs-keyword">this</span>.path).attr({
          ...
          opacity: +((sa.opacity || <span class="hljs-number">0.3</span>) / num_paths).toFixed(<span class="hljs-number">3</span>),</pre></div>
...
on the output SVG in Raphael 2.0+.</p>
          ...
          scale: <span class="hljs-keyword">this</span>.attributes.scale
        }));
      }
    }
  ...
  fill() {
    <span class="hljs-keyword">var</span> elem = <span class="hljs-keyword">this</span>.paper.path(<span class="hljs-keyword">this</span>.path).
      attr(<span class="hljs-keyword">this</span>.attributes).
...
canvascontext.js as well.</p>
          ...
          <div class='highlight'><pre>
    <span class="hljs-keyword">var</span> strokeWidth = <span class="hljs-keyword">this</span>.lineWidth * (<span class="hljs-keyword">this</span>.state.scale.x + <span class="hljs-keyword">this</span>.state.scale.y)/<span class="hljs-number">2</span>;
    <span class="hljs-keyword">var</span> elem = <span class="hljs-keyword">this</span>.paper.path(<span class="hljs-keyword">this</span>.path).
      attr(<span class="hljs-keyword">this</span>.attributes).
      attr(<span class="hljs-string">"fill"</span>, <span class="hljs-string">"none"</span>).
  ...
  measureText(text) {
    <span class="hljs-keyword">var</span> txt = <span class="hljs-keyword">this</span>.paper.text(<span class="hljs-number">0</span>, <span class="hljs-number">0</span>, text).
      attr(<span class="hljs-keyword">this</span>.attributes).
      attr(<span class="hljs-string">"fill"</span>, <span class="hljs-string">"none"</span>).
      attr(<span class="hljs-string">"stroke"</span>, <span class="hljs-string">"none"</span>);
    <span class="hljs-keyword">var</span> bounds = txt.getBBox();
    txt.remove();
  ...
  fillText(text, x, y) {
    <span class="hljs-keyword">this</span>.paper.text(x + (<span class="hljs-keyword">this</span>.measureText(text).width / <span class="hljs-number">2</span>),
        (y - (<span class="hljs-keyword">this</span>.state.font_size / (<span class="hljs-number">2.25</span> * <span class="hljs-keyword">this</span>.state.scale.y))), text).
      attr(<span class="hljs-keyword">this</span>.attributes);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }
  ...
  save() {</pre></div>
      ...
      state: {
        font_family: <span class="hljs-keyword">this</span>.state.font_family
      },
      attributes: {
        font: <span class="hljs-keyword">this</span>.attributes.font,
